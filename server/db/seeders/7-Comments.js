    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          userId: 2,
          productId: 14,
          text: 'не первый мед который закащываю у продовца, товар хорошо запаковон, упаковка просто на пятерку, мед супер вкусный!!!!! качество не умею проверять ..верю что мед без сахара лишнего)',
          isVerified: true,
          likesQuantity: 0,
          createdAt: Sequelize.fn('NOW'),
        },
